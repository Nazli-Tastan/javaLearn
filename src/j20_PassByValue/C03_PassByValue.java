...
public class C03_PassByValue {
    public static void main(String[] args) {
        ...
        /*JAVANIN İSTİSNASI NORMALDE PASS BY VALUE ÇALIŞIR TEK İSTİSNASI..BU..
        Java Non primitive data türlerinde obj kendisi değil de dataları  obj referans ve kendisi değişmediği değişikliklerini kalıcı yapar .
        pass by referans var
        list ve array de istisna
