...
public class Task02 {
    public static void main(String[] args) {
        ...
        h.put("telefon","0 546 450000");
        h.put("adres","Amsterdam/Hollanda");
        h.put("email","ismail@gmail.com");
        h.put("isim","İsmail Demir");
        HashMap<String,HashMap<String,String>>kartvizit=new HashMap<>();
        kartvizit.put("ismail",h);
        System.out.println("kartvizit = " + kartvizit);



//kartvisit.put("isim", new hm("isim","ercan"));BÖYLE İÇ İÇE DE YAZDIRILABİLİR
