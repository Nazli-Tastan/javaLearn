...
public class C03_StringManipulation {
    /*
       ...
       // bu durumda tamamen sayı olduğunu bildiğimiz string varsa parseDouble() veya parseInteger()methodu kullanabilirsiniz

        double sayi1=Double.parseDouble(str1);//String olan str1 sayı olan sayı1 e dönüştü
        double sayi1=Double.parseDouble(str2);//aynı
