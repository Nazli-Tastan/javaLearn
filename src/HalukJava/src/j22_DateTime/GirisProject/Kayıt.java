package HalukJava.src.j22_DateTime.GirisProject;

import j22_DataTime.HaftaninSorusu.Kullanıcı;
...
public class Kayıt {
    ...
    public void sansliKullanici(ArrayList<Kullanıcı> kllObj) {//kulanıcı list'indeki obj'lerin kayıtZamanını 10 sn
       ...
       //    if (k.kayıtZamanı.getNow() <= 10) {//döngüye herbir kullanıc obj kayıtzamanı datasındaki saniye verisi
